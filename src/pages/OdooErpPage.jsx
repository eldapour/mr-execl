...
import { Settings, Users, CheckCircle2, BarChart, Globe, Activity, Shield, Download, ArrowRight } from 'lucide-react';
...
const OdooErpPage = () => {
    ...
    const servicesList = [
        {
            title: t('Business process analysis & solution architecture', 'تحليل العمليات وبناء الحلول المناسبة'),
            icon: <BarChart className="w-6 h-6" />,
        },
        {
            title: t('ERP system configuration & customization', 'إعداد وتخصيص النظام حسب احتياجات النشاط'),
            icon: <Settings className="w-6 h-6" />,
        },
        {
            title: t('Custom module development & enhancements', 'تطوير وحدات مخصصة وتحسينات برمجية'),
            icon: <Activity className="w-6 h-6" />,
        },
        {
            title: t('Integration with third-party systems', 'ربط النظام مع أنظمة خارجية'),
            icon: <Globe className="w-6 h-6" />,
        },
        {
            title: t('System testing & production deployment', 'الاختبار والإطلاق الفعلي'),
            icon: <CheckCircle2 className="w-6 h-6" />,
        },
        {
            title: t('End-user training & knowledge transfer', 'تدريب المستخدمين'),
            icon: <Users className="w-6 h-6" />,
        },
        {
            title: t('Ongoing technical support', 'دعم فني مستمر'),
                    ...
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        >
                            <span className="text-gold-500 text-sm tracking-[0.2em] uppercase font-semibold">
                                {t('Enterprise Solutions', 'حلول المؤسسات')}
                            </span>
                        </motion.div>
                        <motion.h1
                            initial={{ opacity: 0, y: 20 }}
                        ...
                        >
                            {t('Complete Business Transformation', 'تنفيذ أنظمة Odoo ERP')}
                        </motion.p>
                        <motion.p
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto text-center">
                        <h3 className="text-2xl md:text-3xl font-bold mb-8 text-dark-900 dark:text-white">
                            {t('Proven Execution Capability', 'خبرة عملية مثبتة')}
                        </h3>
                        <div className="grid md:grid-cols-2 gap-8 text-left rtl:text-right">
                            <div className="p-6 bg-white dark:bg-dark-800 rounded-2xl border border-black/5 dark:border-white/5">
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                                    {t(
                                        'With 90+ successful projects delivered in the past three years, we bring proven execution capability and structured implementation methodology.',
                                        'نفذنا أكثر من 90 مشروعًا ناجحًا خلال آخر ثلاث سنوات، بخبرة عملية مثبتة.'
                                    )}
                                </p>
                            </div>
                            <div className="p-6 bg-white dark:bg-dark-800 rounded-2xl border border-black/5 dark:border-white/5">
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                                    {t(
                                        'Our ERP solutions empower businesses to manage sales, accounting, inventory, operations, and HR within a single unified system.',
                                        'يساعد النظام على إدارة المبيعات، المخزون، المحاسبة، العمليات، والموارد البشرية من خلال منصة واحدة متكاملة.'
                                    )}
                                </p>
                            </div>
                        </div>
            ...
            <section className="py-20 bg-gold-600 text-black">
                <div className="container mx-auto px-6 text-center">
                    <h2 className="text-3xl md:text-5xl font-bold mb-6">
                        {t('Ready to Transform Your Business?', 'هل أنت مستعد لمستقبل تقني متكامل؟')}
                    </h2>
                    <Link
                        to="/contact"
